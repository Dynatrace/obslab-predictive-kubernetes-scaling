          ...
          export default async function ({action_execution_id}) {
            ...
            const event = {
              ...
              properties: {
                ...
                // Target Utilization
                'kubernetes.predictivescaling.targetutilization.cpu.min': workload.targetUtilization.cpu.min,
                'kubernetes.predictivescaling.targetutilization.cpu.max': workload.targetUtilization.cpu.max,
                'kubernetes.predictivescaling.targetutilization.cpu.point': workload.targetUtilization.cpu.point,
                'kubernetes.predictivescaling.targetutilization.memory.min': workload.targetUtilization.memory.min,
                'kubernetes.predictivescaling.targetutilization.memory.max': workload.targetUtilization.memory.max,
                'kubernetes.predictivescaling.targetutilization.memory.point': workload.targetUtilization.memory.point,
